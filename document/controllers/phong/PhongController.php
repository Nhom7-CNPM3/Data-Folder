...
namespace venndev\restapi\controllers\phong;
...
#[RequestMapping(["value" => "/tbphong"])]
final class PhongController
{
    ...
    #[RequestMapping([
      ...
      {
        $result = Provider::getMySQL()->execute("SELECT * FROM `tbphong` ");
    ...
    public function search(Request $request, Response $response, array $args, array $queryParams) : Response
    {
        ...
        Provider::getMySQL()->execute("SELECT * FROM `tbphong` WHERE `id` = ':a';",
        [
            "a"=> $id
        ])
    ...
    public function delete(Request $request, Response $response, array $args) : Response
    {
        ...
        try
        {
            Provider::getMySQL()->execute("DELETE FROM `tbphong` WHERE `id` = ':a';",
            [
                "a"=> $id
            ])
    ...
    #[RequestMapping([
        "value" => "/edit/{id}/{MaLoaiPhong}/{MaKhachSan}/{MaNhomKhuVucPhong}/{TenPhong}/{GhiChu}/{Status}",
    ...
    public function edit(Request $request, Response $response, array $args) : Response
    {
        ...
        $id = $args["id"];
        $maloaiphong = $args["MaLoaiPhong"];
        $makhachsan = $args["MaKhachSan"];
        $manhomkhuvucphong = $args["MaNhomKhuVucPhong"];
        $tenphong = $args["TenPhong"];
        $ghichu = $args["GhiChu"];
        $status = $args["Status"];
        ...
        Provider::getMySQL()->execute(
            "UPDATE `tbphong` SET `MaLoaiPhong` = ':b', `MaKhachSan` = ':c', `MaNhomKhuVucPhong` = ':d', `TenPhong` = ':e', `GhiChu` = ':f', `Status` = ':g' WHERE `id` = ':a';", 
            [
                "a" => $id,
                "b" => $maloaiphong,
                "c" => $makhachsan,
    ...
    #[RequestMapping([
        "value" => "/add/{id}/{MaLoaiPhong}/{MaKhachSan}/{MaNhomKhuVucPhong}/{TenPhong}/{GhiChu}/{Status}",
        "method" => HttpMethod::POST,
        "produces" => ["application/json"],
    ...
    public function add(Request $request, Response $response, array $args) : Response
    {
        ...
        Provider::getMySQL()->execute(
            "INSERT INTO `tbphong` (id, MaLoaiPhong, MaLoaiPhong, MaNhomKhuVucPhong, TenPhong, GhiChu, Status) VALUES (':a', ':b', ':c', ':d', ':e', ':f', ':g')", 
            [
                "a" => $id,
                "b" => $maloaiphong,
                "c" => $makhachsan,
    ...
    {
        $tencot = $args["TenCot"];
        $result = Provider::getMySQL()->execute("SELECT :a FROM `tbphong`",
            [
                "a" => $tencot
            ]);

...
namespace venndev\restapi\controllers\NhaCungCap;
...
final class NhaCungCapController
{

    private const TABLE_NAME = "tbNhaCungCap";
    ...
    public function search(Request $request, Response $response, array $args, array $queryParams) : Response
    {
        ...
        Provider::getMySQL()->execute("SELECT * FROM `tbNhaCungCap` WHERE `id` = ':a';",
        [
            "a"=> $id
        ])
     ...
     */
    #[RequestMapping([
        "value" => "/edit/{id}/{TenNhaCungCap}/{SDTNhaCungCap}/{EmailNhaCungCap}",
    ...
    public function edit(Request $request, Response $response, array $args) : Response
    {
        ...
        $id = $args["id"];
        $TenNhaCungCap = $args["TenNhaCungCap"];
        $SDTNhaCungCap = $args["SDTNhaCungCap"];
        $EmailNhaCungCap = $args["EmailNhaCungCap"];
        ...
        Provider::getMySQL()->execute(
            "UPDATE `id` SET `TenNhaCungCap` = ':b', `SDTNhaCungCap` = ':c', `EmailNhaCungCap` = :d WHERE `id` = ':a';", 
            [
                "a" => $id,
                "b" => $TenNhaCungCap,
                "c" => $SDTNhaCungCap,
    ...
    public function add(Request $request, Response $response, array $args) : Response
    {
        ...
        Provider::getMySQL()->execute(
            "INSERT INTO `tbNhaCungCap` (id, TenNhaCungCap, SDTNhaCungCap, EmailNhaCungCap) VALUES (':a', ':b', ':c', ':d')", 
            [
                "a" => $id,
                "b" => $TenNhaCungCap,
                "c" => $SDTNhaCungCap,
    ...
    public function delete(Request $request, Response $response, array $args) : Response
    {
        ...
        try
        {
            Provider::getMySQL()->execute("DELETE FROM `tbNhaCungCap` WHERE `id` = ':a';",
            [
                "a"=> $id
            ])
    ...
    {
        $tencot = $args["TenCot"];
        $result = Provider::getMySQL()->execute("SELECT :a FROM `tbNhaCungCap`",
            [
                "a" => $tencot
            ]);

...
namespace venndev\restapi\controllers\chitietdichvudatcho;
...
#[RequestMapping(["value" => "/tbchitietdichvudatcho"])]
final class ChiTietDichVuDatChoController
{
    ...
    #[RequestMapping([
      ...
      {
        $result = Provider::getMySQL()->execute("SELECT * FROM `tbchitietdichvudatcho` ");
    ...
    public function search(Request $request, Response $response, array $args, array $queryParams) : Response
    {
        ...
        Provider::getMySQL()->execute("SELECT * FROM `tbchitietdchvudatcho` WHERE `id` = ':a';",
        [
            "a"=> $id
        ])
    ...
    public function delete(Request $request, Response $response, array $args) : Response
    {
        ...
        try
        {
            Provider::getMySQL()->execute("DELETE FROM `tbchitietdichvudatcho` WHERE `id` = ':a';",
            [
                "a"=> $id
            ])
    ...
    #[RequestMapping([
        "value" => "/edit/{id}/{MaDatCho}/{MaDichVu}/{MaHoaDon}/{DiaChiChiNhanh}",
    ...
    public function edit(Request $request, Response $response, array $args) : Response
    {
        ...
        $id = $args["id"];
        $madatcho = $args["MaDatCho"];
        $madichvu = $args["MaDichVu"];
        $mahoadon = $args["MaHoaDon"];
